...
from src.file import dump_collection, get_filenames, load_collection, loads, read, write
from src.text import print_statistics
from src.visual import get_color, get_style
from src.analysis.analysis import add_children, get_details, get_paths, print_details
from src.analysis.details import generate, process_details
from src.analysis.genetic import process_genetics
...
from src.pycrypt import encrypt, decrypt
...
def backup_all_data(paths: list[str]) -> None:
    # Get all data from JSON files
    filenames: list = get_filenames(paths)
